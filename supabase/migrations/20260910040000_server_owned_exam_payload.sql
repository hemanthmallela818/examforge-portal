-- Build the candidate's randomized paper from the protected database copy.
-- Client-supplied exam content is retained in the signature only for API compatibility.
